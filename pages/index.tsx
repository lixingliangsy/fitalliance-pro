...
export default function Home() {
  ...
  async function runStudio(e?: FormEvent) {
    ...
    try {
      ...
      for (const k of ['goal', 'members', 'focus', 'niche', 'cadence', 'challenge', 'duration', 'habit', 'audience', 'notes', 'paragraph', 'count', 'brand', 'competitors', 'topic', 'angle', 'community', 'program', 'commits', 'text', 'article', 'endpoints', 'notes', 'goal', 'topic', 'industry', 'products', 'brand', 'resume', 'jd', 'data', 'log', 'citation', 'comps', 'prospect', 'system', 'role', 'region', 'seniority', 'diff', 'product', 'client', 'amount', 'days_overdue', 'tone', 'emails', 'config_text', 'scope', 'feedback']) {
  ...
  return (
    <>
      <Head>
        ...
        <link rel="canonical" href="https://fitalliance-pro.lxsaihub.com/" />
      
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: `{"@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [{"@type": "Question", "name": "What is FitAlliance Pro?", "acceptedAnswer": {"@type": "Answer", "text": "FitAlliance Pro is a fitness community and coaching hub for trainers and studio owners, with programs, check-ins, a coach dashboard, and a community feed."}}, {"@type": "Question", "name": "What does the coach dashboard show?", "acceptedAnswer": {"@type": "Answer", "text": "It rolls up member progress so a trainer sees who is on track at a glance."}}, {"@type": "Question", "name": "Can members track progress?", "acceptedAnswer": {"@type": "Answer", "text": "Yes. Members log progress and it shows up in the coach dashboard and their own view."}}, {"@type": "Question", "name": "Is there a community feature?", "acceptedAnswer": {"@type": "Answer", "text": "A community feed keeps members connected and engaged between sessions."}}, {"@type": "Question", "name": "Who should use it?", "acceptedAnswer": {"@type": "Answer", "text": "Trainers and studio owners who want programs, coaching, and community in one place."}}, {"@type": "Question", "name": "Does it replace several tools?", "acceptedAnswer": {"@type": "Answer", "text": "It combines programs, check-ins, progress, and community that are often split across separate apps."}}]}` }} />
        </Head>
      ...
      <div className="min-h-screen bg-white text-slate-900">
        ...
        <section id="definition" className="py-20 bg-slate-50">
          <div className="max-w-6xl mx-auto px-6">
            ...
            <h2 className="text-3xl md:text-4xl font-extrabold mb-4">FitAlliance Pro - definition</h2>
