 ...
 *
 * <script src="https://YOUR_DOMAIN/widget.js" data-host="https://YOUR_DOMAIN" data-product="fitalliance-pro" async></script>
 *
...
(function () {
  ...
  host = host.replace(/\/+$/, "");
  var product = (tag && tag.getAttribute("data-product")) || "fitalliance-pro";
  ...
  function build() {
    ...
    var panel = null;
    var sessionKey = (product || "fitalliance-pro") + "_chat_session";
