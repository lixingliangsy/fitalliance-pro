  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content={NAME + " — How Fitalliance Pro handles your data and the compliance posture it maintains."} />
      </Head>
      <div className="min-h-screen bg-slate-50 text-slate-800">
        ...
        <main className="max-w-3xl mx-auto px-6 py-14">
          ...
          <p className="mt-2 text-slate-600">Fitalliance Pro processes the text or configuration you submit to produce its output. We do not train public models on your submissions without explicit consent.</p>
