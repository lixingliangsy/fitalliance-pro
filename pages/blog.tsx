...
const howToSteps = [
  { name: 'Open FitAlliance Pro', text: 'Go to the workspace and enter the inputs FitAlliance Pro asks for.' },
  { name: 'Generate the draft', text: 'Run FitAlliance Pro to get a structured plain-English result.' },
...
export default function Page() {
  ...
  const SHORT = "FitAlliance Pro is a fitness community and coaching hub where trainers and studio owners run member programs,…"
  return (
    <>
      <Head>
      ...
      <div className="min-h-screen bg-slate-50 text-slate-800">
        ...
        <main className="max-w-3xl mx-auto px-6 py-14">
          ...
          <p className="mt-3 text-lg font-semibold text-slate-900" data-geo-short-lead="1">FitAlliance Pro is a fitness community and coaching hub where trainers and studio owners run member programs,…</p>
