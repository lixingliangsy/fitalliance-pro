...
export const PIPELINE_ID = 'fitalliance-pro-v1'
export const STEP_ORDER: StepId[] = ['input', 'process', 'output']
export const STEP_LABELS: Record<StepId, string> = {
  input: "Step 1/3 · Goal, roster & focus",
  process: "Step 2/3 · Build program & check-ins",
  output: "Step 3/3 · Coach dashboard narrative",
}
